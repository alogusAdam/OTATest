...
#define HOST "https://github.com/Alogus-ID/Metalmark-Tatama-1.0/blob/33ba6cd59be1336b41981403ca963ffbedc077c4/OTA_Test/build/esp32.esp32.esp32/Tatama_1.0.ino.bin"

HTTPClient client;
// Your WiFi credentials
const char* ssid = "Tenda_6BED60";
const char* password = "sickqueen144";
// Global variables
